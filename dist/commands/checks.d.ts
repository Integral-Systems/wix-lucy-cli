...
export declare const checkForVelo: () => Effect.Effect<undefined, import("@effect/platform/Error").PlatformError | import("effect/ParseResult").ParseError | AppError, Config | FileSystem.FileSystem | Path.Path>;
